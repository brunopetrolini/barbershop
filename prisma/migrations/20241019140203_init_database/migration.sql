...
-- AddForeignKey
ALTER TABLE "bookings" ADD CONSTRAINT "bookings_barbershop_id_fkey" FOREIGN KEY ("barbershop_id") REFERENCES "barbershops"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
